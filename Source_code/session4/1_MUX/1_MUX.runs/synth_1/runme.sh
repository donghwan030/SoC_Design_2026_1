...
HD_PWD='/home_cds/std012/SoC_Design_2026_1/SoC_Design_2026_1/Source_code/session4/1_MUX/1_MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_mux.tcl
