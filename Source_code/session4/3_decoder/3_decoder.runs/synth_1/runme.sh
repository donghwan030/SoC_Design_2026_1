...
HD_PWD='/home_cds/std012/SoC_Design_2026_1/SoC_Design_2026_1/Source_code/session4/3_decoder/3_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_to_7seg.tcl
